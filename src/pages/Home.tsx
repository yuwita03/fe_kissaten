...
export default function Home() {
  ...
  return (
    <div id="home-page" className="min-h-screen">
      {/* 100vh Full Bleed Video Hero */}
      <VideoHero />

      {/* Overlapping Intro Section */}
      <section
        id="intro-section"
        className="relative z-20 -mt-12 rounded-t-3xl bg-cream-main dark:bg-dark-roasted shadow-2xl p-6 sm:p-10 md:p-16 border-t border-warm-sand/30 dark:border-dark-slate/60 max-w-7xl mx-auto"
      >
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
              <div className="p-4 rounded-2xl bg-white dark:bg-dark-slate/40 border border-warm-sand/30 dark:border-dark-slate/60 shadow-xs space-y-2">
                ...
                <h4 className="font-bold text-xs uppercase tracking-wider text-coffee-brown dark:text-cream-main">
                  100% Specialty
                </h4>
                <p className="text-[11px] text-coffee-brown/70 dark:text-warm-sand/70">
                  Ethically sourced single-origin Arabica micro-lots.
                </p>
              </div>
              ...
              <div className="p-4 rounded-2xl bg-white dark:bg-dark-slate/40 border border-warm-sand/30 dark:border-dark-slate/60 shadow-xs space-y-2">
                ...
                <p className="text-[11px] text-coffee-brown/70 dark:text-warm-sand/70">
                  Craft roasted weekly in small batches in Indonesia.
                </p>
              </div>
            </div>
          </div>

          {/* Column 2: Warm Visual Atmospheric Card */}
      ...
      <section id="selected-drops" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 text-sm font-bold text-amber-gold hover:text-amber-gold/80 group transition-colors self-start md:self-auto"
          >
        ...
        <div className="mt-14 p-8 rounded-3xl bg-amber-gold/10 dark:bg-dark-slate/40 border border-amber-gold/30 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="space-y-1 text-center sm:text-left">
            <h3 className="text-lg font-bold text-coffee-brown dark:text-cream-main font-poppins">
              Looking for our complete seasonal menu?
            </h3>
          ...
          <Link
            to="/menu"
            className="px-6 py-3 rounded-xl bg-amber-gold text-dark-roasted font-bold text-xs sm:text-sm tracking-wider uppercase hover:bg-amber-gold/90 transition shadow-md shrink-0"
          >
            Explore All Items
          </Link>
        </div>
